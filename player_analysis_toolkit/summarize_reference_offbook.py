...
def main() -> int:
    ...
    records_output = {
        ...
        "validationTool": "agent_offbook_review.py offbook-record",
    ...
    for item in comparisons:
        ...
        report_lines.extend(
            [
                ...
                "",
                f"- 对手：{item['opponentName']}（{item['opponentAccount']}）；"
                f"目标账号 {item['targetAccount']} 执{'黑' if item['targetColor'] == 'black' else '白'}。",
