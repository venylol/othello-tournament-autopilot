...
export const Switcher = ({flagTest, flagLO, flagFinals, flagCategories, flagXOT, setSettings, defaultCategories, flagCountry}) => {
    const [checkedTest, setCheckedTest] = useState(flagTest)
    const [checkedLO, setCheckedLO] = useState(flagLO)
    ...
    const [checkedCountry, setCheckedCountry] = useState(flagCountry)
